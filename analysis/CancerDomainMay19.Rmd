---
title: "Twitter coverage of the 'Rethinking Cancer' UCL Cancer Domain Symposium"
...
tweets %>%
    ...
    mutate(datetime = as_datetime(created_at, tz = timezone)) %>%
    ggplot(aes(datetime, 1, shape = is_retweet, colour = screen_name, fill = screen_name)) +
...
out <- knit_child(text = unlist(c("## Top tweeters by day", src_list)))
```
